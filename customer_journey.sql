--CTE to identify and tag duplicate tags
...
WITH DuplicateRecords AS (
	SELECT
		...
		Action,
		Duration,
		ROW_NUMBER() OVER(Partition By JourneyID, CustomerID, ProductID, VisitDate, Stage, Action, Duration ORDER BY JourneyID) AS row_num
...
------- Outer query to find the final cleaned standarized data
